...
export const DetallePublicacion = ({ onUpdate, rows, setTableRows }) => {
	...
	return (
		<div>
			...
			<TextEditor />
			<Filtros />
			<FileAttacher idPublicacion={idPublicacion} isRemote={true} tipoPublicacion={tipoPublicacion} />
			<div style={{display:'flex',justifyContent:'flex-end'}}>
				<Button variant="contained" color="primary" onClick={handleButtonUpdate}>
					Actualizar
				</Button>
			</div>
		</div>
