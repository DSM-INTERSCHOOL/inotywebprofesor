...
export const SET_PUBLICACION_REQUIERE_AUTORIZACION =
  "SET_PUBLICACION_REQUIERE_AUTORIZACION";

export const SET_CALIFICATION_OPTIONS = "SET_CALIFICATION_OPTIONS";
...
export const setPublicacionRequiereAutorizacion = (
  publicacionRequiereAutorizacion
) => {
  return {
    type: SET_PUBLICACION_REQUIERE_AUTORIZACION,
    publicacionRequiereAutorizacion: publicacionRequiereAutorizacion,
  };
};
...
export const setCalificacionOptionsAction = (calificacionOptions) => {
  return { type: SET_CALIFICATION_OPTIONS, calificacionOptions };
};
